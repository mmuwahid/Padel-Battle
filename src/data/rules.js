...
export const SECTIONS = [
  ...
  },
  {
    ...
    subtitle: "How each Game Mode works",
    accent: "rules",
    icon: "gamemode",
    rules: [
      {
        ...
        tags: [
          { l: "Quick session", c: "g" },
          { l: "Individual scoring", c: "g" },
          { l: "Partner rotates", c: "go" },
        ],
      },
      {
        id: "fmt-mexicano",
        ...
        tags: [
          { l: "Adaptive pairings", c: "g" },
          { l: "Balanced matches", c: "g" },
          { l: "Re-seeded each round", c: "go" },
        ],
      },
      {
        id: "fmt-round-robin",
      ...
      },
      {
        ...
        tags: [
          { l: "Fastest format", c: "g" },
          { l: "Single loss = out", c: "r" },
          { l: "Best 4–16 teams", c: "go" },
        ],
      },
      {
        id: "fmt-double-elim",
