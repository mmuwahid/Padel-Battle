...
export default function Icon({ name, size = 20, color = "currentColor", strokeWidth = 1.75 }) {
  ...
  switch (name) {
    ...
    case "racket":      return <svg style={s} viewBox="0 0 24 24" {...p}><ellipse cx="10.5" cy="9.5" rx="6.5" ry="7"/><line x1="10.5" y1="2.5" x2="10.5" y2="16.5"/><line x1="4" y1="9.5" x2="17" y2="9.5"/><line x1="15.5" y1="16" x2="21" y2="21.5"/></svg>;
    case "players":     return <svg style={s} viewBox="0 0 24 24" {...p}><circle cx="9" cy="6" r="3.5"/><path d="M2 21v-1.5A5.5 5.5 0 0 1 7.5 14h3A5.5 5.5 0 0 1 16 19.5V21"/><circle cx="18" cy="7" r="2.5"/><path d="M21 21v-1a4 4 0 0 0-2.5-3.7"/></svg>;
    case "gamemode":    return <svg style={s} viewBox="0 0 24 24" {...p}><path d="M4 20L20 4M4 4l4 4M20 20l-4-4"/><circle cx="5.5" cy="5.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>;
    ...
    case "back":        return <svg style={s} viewBox="0 0 24 24" {...p}><polyline points="15 18 9 12 15 6"/></svg>;
    ...
    case "settings":    return <svg style={s} viewBox="0 0 24 24" {...p}><circle cx="12" cy="12" r="3"/><path d="M12 1v3M12 20v3M4.22 4.22l2.12 2.12M17.66 17.66l2.12 2.12M1 12h3M20 12h3M4.22 19.78l2.12-2.12M17.66 6.34l2.12-2.12"/></svg>;
